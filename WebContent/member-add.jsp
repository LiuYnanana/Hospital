        ...
        <form class="layui-form" action="Member_add">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="input1" name="departmentname" required="" lay-verify="nikename"
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="input2" name="departmentnumber" required="" lay-verify="pass"
         ...
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="input3" name="departmentdiscription" required="" lay-verify="nikename"
                  autocomplete="off" class="layui-input" oninput="judgeNull()">
              </div>
              <span id="hint3"></span>
          </div>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="Member_list.jsp"	class="btn btn-primary" role="button">确定</a>
...
function judgeOneDp() {
	    var departmentName= $("#input1").val();
	    if(departmentName != "") {
	    	 $("#input1").css('borderColor','');   
	    }
	    $.ajax({
	      url:"<%=request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/" %>Member_add",//访问的地址
          type:"post",
          data:{
          ...
          success:function(data) {
        	  ...
        	  if(data == "exist") {	
        		  ...
        		  document.getElementById("hint1").innerHTML = "*该科室已存在";
...
function nullFunction() {
	...
	if(flag) {
         var departmentName = $("#input1").val();
   	     var departmentNum = $("#input2").val();
		 var departmentDsc = $("#input3").val();
		  ...
		  $.ajax({
	          ...
	          data:{
	        	  ...
	        	  "departmentdiscription" : departmentDsc 
	        	  },
	          dataType:'text',//后台返回的数据格式类型
	          success:function(data){
	        	  if(data == "yes") {
